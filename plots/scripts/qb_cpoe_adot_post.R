...
# save the plot
brand_plot(p_desktop, asp = 16/10, save_name = glue('plots/desktop/qb_cpoe_vs_dot/post_qb_cpoe_vs_dot_{current_season}.png'), data_home = 'Data: @nflfastR', fade_borders = '')

# save the plot
brand_plot(p_mobile, asp = 9/16, save_name = glue('plots/mobile/qb_cpoe_vs_dot/post_qb_cpoe_vs_dot_{current_season}.png'), data_home = 'Data: @nflfastR', fade_borders = '')
