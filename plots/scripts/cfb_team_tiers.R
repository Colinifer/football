...
#   readRDS(url(
#     glue::glue("https://github.com/guga31bb/cfbfastR-data/blob/master/data/play_by_play_{x}.rds?raw=true")
#   ))
# # }) %>% filter(week < 9)
...
brand_plot(p, asp = 16/10, save_name = glue('plots/desktop/cfb_team_tiers/cfb_early_down_team_tiers_{current_season}.png'), data_home = 'Data: cfbfastR', fade_borders = '')
...
brand_plot(p, asp = 16/10, save_name = glue('plots/desktop/cfb_team_tiers/cfb_team_off_pass_and_rush_tiers_{current_season}.png'), data_home = 'Data: @cfbfastR', fade_borders = '')
...
brand_plot(p, asp = 16/10, save_name = glue('plots/desktop/cfb_team_tiers/cfb_team_def_pass_and_rush_tiers_{current_season}.png'), data_home = 'Data: @cfbfastR', fade_borders = '')
...
if (n_week < 17) {
  ...
  p <- matchup_chart_all %>% 
    ...
    labs(x = "Offense EPA/play",
         ...
         # caption = "Data: @cfbscrapR",
         title = glue("{current_season} CFB Team Tiers Matchups through Week {n_week}"),
  ...
  brand_plot(p, asp = 16/10, save_name = glue('plots/desktop/cfb_team_tiers/cfb_matchup_team_tiers_{current_season}.png'), data_home = 'Data: @cfbfastR', fade_borders = '')
  ...
  p <- matchup_chart_all %>% 
    ...
    labs(x = "Offense Pass EPA/play",
         ...
         # caption = "Data: @cfbscrapR",
         title = glue("{current_season} CFB Team Tiers Passing Matchups through Week {n_week}"),
  ...
  brand_plot(p, asp = 16/10, save_name = glue('plots/desktop/cfb_team_tiers/cfb_matchup_pass_team_tiers_{current_season}.png'), data_home = 'Data: @cfbfastR', fade_borders = '')
  ...
  p <- matchup_chart_all %>% 
    ...
    labs(x = "Offense Rush EPA/play",
         ...
         # caption = "Data: @cfbscrapR",
         title = glue("{current_season} CFB Team Tiers Rushing Matchups through Week {n_week}"),
  ...
  brand_plot(p, asp = 16/10, save_name = glue('plots/desktop/cfb_team_tiers/cfb_matchup_rush_team_tiers_{current_season}.png'), data_home = 'Data: @cfbfastR', fade_borders = '')
}
end_time <- Sys.time()
end_time - start_time
