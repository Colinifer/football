...
u.team_remaining_opp <- matchup_df %>% 
  filter(week > n_week & 
           posteam == u.team) %>% 
  pull(oppteam)
...
epa_data <- pbp_df %>%
  filter(posteam %in% c(u.team, u.team_remaining_opp) |
           defteam %in% c(u.team, u.team_remaining_opp)) %>% 
  # dplyr::filter(!is.na(epa), !is.na(ep), !is.na(posteam), play_type == "pass" | play_type == "run") %>%
  dplyr::filter(!is.na(posteam) & (rush == 1 | pass == 1)) %>% 
  dplyr::filter(posteam == "PIT")
...
brand_plot(p, asp = 16/10, save_name = glue('plots/playground/{u.team}_team_tiers_adj_{year}.png'), data_home = 'Data: @nflfastR', fade_borders = '')
...
brand_plot(p, asp = 16/10, save_name = glue('plots/playground/{u.team}_team_tiers_{year}.png'), data_home = 'Data: @nflfastR', fade_borders = '')
...
brand_plot(p, asp = 16/10, save_name = glue('plots/playground/{u.team}_team_off_pass_and_rush_tiers_{year}.png'), data_home = 'Data: @nflfastR', fade_borders = '')
...
brand_plot(p, asp = 16/10, save_name = glue('plots/playground/{u.team}_team_def_pass_and_rush_tiers_{year}.png'), data_home = 'Data: @nflfastR', fade_borders = '')
...
brand_plot(p, asp = 16/10, save_name = glue('plots/playground/{u.team}_matchup_team_tiers_{year}.png'), data_home = 'Data: @nflfastR', fade_borders = '')
...
brand_plot(p, asp = 16/10, save_name = glue('plots/playground/{u.team}_matchup_pass_team_tiers_{year}.png'), data_home = 'Data: @nflfastR', fade_borders = '')
...
brand_plot(p, asp = 16/10, save_name = glue('plots/playground/{u.team}_matchup_rush_team_tiers_{year}.png'), data_home = 'Data: @nflfastR', fade_borders = '')
