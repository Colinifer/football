...
p <- ggplot(data = freq_passers, aes(y = tm_ADOT_order, x = air_yards)) +
  ...
  geom_shadowtext(aes(label = full_name, x = 35), nudge_y = .75, hjust = 1, family='Helvetica', size = 0.8 * img_size_adj, color = 'darkblue', bg.color = 'white', bg.r = 0.15) +
  geom_shadowtext(data = team_df, aes(label = posteam, x = -1, y = 4.8), angle = 45, family='Helvetica', size = 1.5 * img_size_adj, color = 'darkblue', bg.color = 'white', bg.r = 0.1) +
  geom_shadowtext(aes(label = 0, x = 0, y = 1), nudge_y = -0.15, family='Helvetica', size = 0.7 * img_size_adj, color = 'grey70', bg.color = 'white', bg.r = 0.15) +
  geom_shadowtext(aes(label = 10, x = 10, y = 1), nudge_y = -0.15, family='Helvetica', size = 0.7 * img_size_adj, color = 'grey70', bg.color = 'white', bg.r = 0.15) +
  geom_shadowtext(aes(label = 20, x = 20, y = 1), nudge_y = -0.15, family='Helvetica', size = 0.7 * img_size_adj, color = 'grey70', bg.color = 'white', bg.r = 0.15) +
  geom_shadowtext(aes(label = 30, x = 30, y = 1), nudge_y = -0.15, family='Helvetica', size = 0.7 * img_size_adj, color = 'grey70', bg.color = 'white', bg.r = 0.15) +
...
p_new <- ggplot(freq_passers, aes(y = tm_ADOT_order, x = air_yards)) +
  geom_image(data = team_df, aes(image = logo, x = 17.5, y = 2.8), size = 0.80) +
  geom_image(data = team_df, aes(image = logo, x = 17.5, y = 2.8), size = 0.80, color = 'white', alpha = 0.8) +
  geom_image(data = headshot_df, aes(image = pff_url, x = 38, y = tm_ADOT_order), size = 0.22, nudge_y = 0.5) +
  geom_density_ridges2(aes(y = tm_ADOT_order, fill = posteam, color = posteam), scale = 1.7, size = 0.2, na.rm = T, show.legend = F, bandwidth = 2, panel_scaling = F) +
  ...
  geom_shadowtext(aes(label = full_name, x = 35), nudge_y = .75, hjust = 1, size = 0.8, color = 'darkblue', bg.color = 'white', bg.r = 0.15) +
  geom_shadowtext(data = team_df, aes(label = posteam, x = -1, y = 4.8), angle = 45, size = 1.5, color = 'darkblue', bg.color = 'white', bg.r = 0.1) +
  geom_shadowtext(aes(label = 0, x = 0, y = 1), nudge_y = -0.15, size = 0.7, color = 'grey70', bg.color = 'white', bg.r = 0.15) +
  geom_shadowtext(aes(label = 10, x = 10, y = 1), nudge_y = -0.15, size = 0.7, color = 'grey70', bg.color = 'white', bg.r = 0.15) +
  geom_shadowtext(aes(label = 20, x = 20, y = 1), nudge_y = -0.15, size = 0.7, color = 'grey70', bg.color = 'white', bg.r = 0.15) +
  geom_shadowtext(aes(label = 30, x = 30, y = 1), nudge_y = -0.15, size = 0.7, color = 'grey70', bg.color = 'white', bg.r = 0.15) +
  scale_color_manual(values = outline_col) + 
  scale_fill_manual(values = fill_col) + 
  facet_wrap(~ posteam, ncol = 4, nrow = 8, shrink= F) +
  labs(title = 'Receiver Depth of Target Distribution', 
...
# brand_plot(p, asp = 16/9, save_name = 'Team_WR_ridge_DOT_2019.png', data_home = 'Data: @nflscrapR')
