...
gg.min <- 20 ## What is the minimum receiving yards for the sample?
...
f.gg_file <- paste("plots/mobile/targets_1440mobile.png", sep = "")
ggsave(f.gg_file, targetsplot_mobile, width = 14, height = 25, dpi = 100, limitsize = FALSE)
f.gg_file <- paste("plots/mobile/targets_1080mobile.png", sep = "")
...
f.gg_file <- paste("plots/desktop/targets_1440desktop.png", sep = "")
ggsave(f.gg_file , targetsplot_desktop, width = 25, height = 14, dpi = 100, limitsize = FALSE)
f.gg_file <- paste("plots/desktop/targets_1080desktop.png", sep = "")
