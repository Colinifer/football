...
LEFT JOIN "defteam_passing" b ON a.team = b.team AND a.season = b.season
LEFT JOIN "posteam_rushing" c ON a.team = c.team AND a.season = c.season
LEFT JOIN "defteam_rushing" d ON a.team = d.team AND a.season = d.season;